...
const Home = React.forwardRef((props, ref) => {
  ...
  // const values =["Pradnya Bhukan", "Developer", "Coder", "Student"]
  // // const values =["Pradnya Bhukan", "Developer", "Coder", "Student"];
  
  // const [name, setName] = useState("");
  // const [counter, setCounter] = useState(0);
  // const [displayMode, setDisplayMode] = useState("typing"); // "typing", "deleting", or "waiting"
  // const [waitingTimer, setWaitingTimer] = useState(null);

  // useEffect(() => {
  //   const timer = setInterval(() => {
  //     setCounter((prevCounter) => (prevCounter + 1) % values.length);
  //     setDisplayMode("typing"); // Switch to typing mode when switching values
  //   }, 3000);
  ...
  //       const currentValue = values[counter];
  //       const currentLength = name.length;
  //       const targetLength = currentValue.length;

  //       if (currentLength < targetLength) {
  //         setName(currentValue.slice(0, currentLength + 1));
  //       } else if (currentLength === targetLength) {
  //         setDisplayMode("waiting"); // Switch to waiting mode after typing
  //         const timer = setTimeout(() => {
  //           setDisplayMode("deleting"); // Switch to deleting mode after waiting
  //         }, 2000);
  //         setWaitingTimer(timer);
  //       }
  //     }, 100);
  //   } else if (displayMode === "deleting") {
  ...
  //         setName(currentValue.slice(0, currentLength - 1));
  //       } else {
  //         setDisplayMode("typing"); // Switch back to typing mode after deleting
  //         setCounter((prevCounter) => (prevCounter + 1) % values.length);
  //       }
  //     }, 100);
  //   }
  ...
  //   };
  // }, [counter, name, values, displayMode, waitingTimer]);

  // const words = ["Mihir Jethwa", "Software Developer", "Full Stack Developer", "Coder"];
  const words = useMemo(() => ["Pradnya Bhukan", "Developer", "Coder", "UI/UX Developer"], []);
  ...
  }, [currentIndex, currentWord, isTyping, words]);

  return (
    <div ref={ref} className="home">
      <Container>
        <Row>
          <Col className="fade-up-animation" md={6}>
            <div class="svgimg">
              <svg
          ...
          <Col
            md={6}
            className=" fade-up-animation d-flex align-items-center text-wheat justify-content-center"
          >
            <div className="">
              <h1 className="large-font gradient-text">HELLO!</h1>
              <p className="large-font-content">I am</p>{" "}
              {/* Added a wrapper div */}
              <span id="name" className="large-font-content">
                {currentWord}
              </span>{" "}
              {/* Use the span element to display the name */}
            </div>
          </Col>
        </Row>
      </Container>
